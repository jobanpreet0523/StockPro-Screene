...
Set `VITE_ANALYTICS_ENABLED=true` and configure `VITE_SENTRY_DSN` and/or `VITE_POSTHOG_KEY`. `VITE_POSTHOG_HOST` defaults to `https://app.posthog.com`; use the host assigned to the PostHog project.
