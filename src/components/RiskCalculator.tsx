            ...
            <div className="flex flex-col gap-5 relative z-10">
               ...
               <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
                    ...
                    <div className="text-[10px] text-slate-500 mt-1 font-mono">Risking ₹{typeof stats.riskPerShare === 'number' ? stats.riskPerShare.toFixed(2) : Number(stats.riskPerShare || 0).toFixed(2)} / share</div>
                  </div>
               </div>
               ...
               {stats.sizeWarningText && (
                  <div className={`p-3 rounded-lg border flex items-center gap-3 ${stats.sizeWarningBg}`}>
                     ...
                     <div>
                       ...
                       <div className="text-[11px] text-slate-400 mt-0.5">This trade requires {typeof stats.allocationPercent === 'number' ? stats.allocationPercent.toFixed(1) : Number(stats.allocationPercent || 0).toFixed(1)}% of your capital. Target is &lt; 20%.</div>
                     </div>
                  </div>
               )}
                  ...
                  <div className={`p-3 rounded-lg border flex items-center gap-3 ${
                    ...
                    'bg-slate-800/50 border-slate-700/50'
                     ...
                     <div>
                       ...
                       <div className="text-[11px] text-slate-400 mt-0.5">Risk/Reward Ratio is 1 : {typeof stats.rrRatio === 'number' ? stats.rrRatio.toFixed(2) : Number(stats.rrRatio || 0).toFixed(2)}</div>
                     </div>
                  </div>
               )}
               ...
               <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="bg-slate-800/30 p-3 rounded-lg border border-slate-700/30">
                    ...
                    <span className="text-sm font-bold font-mono text-sky-400">{typeof stats.returnOnCapital === 'number' ? stats.returnOnCapital.toFixed(1) : Number(stats.returnOnCapital || 0).toFixed(1)}%</span>
                  </div>
               </div>
               ...
               <div className="mt-2">
                  <div className="flex justify-between text-[10px] font-mono font-bold mb-1.5">
                     <span className="text-slate-400">Capital Utilized ({typeof stats.allocationPercent === 'number' ? stats.allocationPercent.toFixed(1) : Number(stats.allocationPercent || 0).toFixed(1)}%)</span>
