    ...
    <div className="space-y-6 pb-20 md:pb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start pb-20 md:pb-6">
        ...
        <div 
          ...
          className={`${isBuilderDismissed ? 'hidden xl:hidden' : 'flex'} lg:col-span-12 xl:col-span-5 bg-white/20 dark:bg-slate-950/40 backdrop-blur-xl border border-slate-205/50 dark:border-slate-850 rounded-2xl shadow-sm p-4 sm:p-5 flex flex-col gap-5`}
        >
