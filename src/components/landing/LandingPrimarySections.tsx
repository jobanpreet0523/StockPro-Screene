...
import {
  Activity, ArrowRight, BarChart3, CalendarDays, FileSearch, Flame, KeyRound,
  LayoutDashboard, Newspaper, Radar, ScanSearch,
} from 'lucide-react';
...
import { ReadinessPill, SectionHeading, TrackedLink, useVisibleOnce } from './LandingPrimitives';
import LandingSceneFallback from '../landing3d/LandingSceneFallback';

const DeferredLandingSections = lazy(() => import('./LandingDeferredSections'));
...
export default function LandingPrimarySections() {
